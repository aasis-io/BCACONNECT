...
var confirmDialog = function confirmDialog2() {
  ...
  var show = function show2() {
    ...
    OverlayService.emit("confirm-dialog", _objectSpread3(_objectSpread3(_objectSpread3({}, props), updatedProps), {
      visible: true
    }));
  };
...
var ConfirmDialog = React12.memo(React12.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  var context = React12.useContext(PrimeReactContext);
  var props = ConfirmDialogBase.getProps(inProps, context);
  var _React$useState = React12.useState(props.visible), _React$useState2 = _slicedToArray2(_React$useState, 2), visibleState = _React$useState2[0], setVisibleState = _React$useState2[1];
  var _React$useState3 = React12.useState(false), _React$useState4 = _slicedToArray2(_React$useState3, 2), reshowState = _React$useState4[0], setReshowState = _React$useState4[1];
  var confirmProps = React12.useRef(null);
  var isCallbackExecuting = React12.useRef(false);
  var focusElementOnHide = React12.useRef(null);
  ...
  var createFooter = function createFooter2() {
    ...
    var content2 = React12.createElement(React12.Fragment, null, React12.createElement(Button, rejectButtonProps), React12.createElement(Button, acceptButtonProps));
  ...
  var createElement7 = function createElement8() {
    ...
    var icon = IconUtils.getJSXIcon(getPropValue("icon"), _objectSpread3({}, iconProps), {
      props: currentProps
    });
    var footer2 = createFooter();
    ...
    return React12.createElement(Dialog, _extends6({}, rootProps, {
      content: inProps === null || inProps === void 0 ? void 0 : inProps.content
    }), icon, React12.createElement("span", messageProps, message));
  };
